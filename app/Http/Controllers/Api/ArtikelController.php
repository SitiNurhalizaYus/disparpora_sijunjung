...
class ArtikelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Membuat query untuk mengambil data tipe 'artikel'
        $query = Content::where('type', 'artikel');
    ...
    public function store(Request $request)
    {
        ...
        $data = Content::create(array_merge($request->all(), ['type' => 'artikel']));
    ...
    public function update(Request $request, $id_content)
    {
        ...
        $query = Content::where('type', 'artikel')->findOrFail($id_content);
        $query->update($request->all());

        $data = Content::where('type', 'artikel')->findOrFail($id_content);
