...
class BeritaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // query
        $query = Content::with(['arsip', 'category'])->where('type', 'berita');
    ...
    public function store(Request $request)
    {
        ...
        $req = $request->all();
        $req['type'] = 'berita'; // Mengatur tipe sebagai 'berita'
    ...
    public function update(Request $request, $id)
    {
        ...
        $query = Content::where('type', 'berita')->findOrFail($id);
        $req = $request->all();
        $query->update($req);

        $data = Content::where('type', 'berita')->findOrFail($id);
