...
class BigNumberController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $req = $request->post();
        $query = BigNumber::findOrFail($id);
        $query->update($req);

        $data = BigNumber::findOrFail($id);
     ...
     *     operationId="big_number_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
