                    ...
                    <div class="card-header">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div style="display: flex;">
                                <a href="{{ url("/admin/testimony/".$id."/edit") }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
        ...
        $.ajax({
            ...
            success: function (result) {
                if(result['success'] == true) {
                    ...
                    $('#testimony').html(result['data']['testimony']);
