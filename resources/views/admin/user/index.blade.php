    ...
    <div class="container-fluid content-inner mt-n5 py-0" style="margin-top: 100px !important;">
        <div class="card-header mb-2 px-3">
            <div class="flex-wrap d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ url('/admin/users/create') }}" class="btn btn-md 2 btn-primary">
                        ADD+
                    </a>
                </div>
            </div>
        ...
        $('#datatable').DataTable({
            ...
            ajax: function(data, callback, settings) {
                ...
                if (!sort_col_name || sort_col_name === null) {
                    sort_col_name = 'id_user'; // Set kolom default untuk pengurutan jika tidak valid
                }
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        var btn_detail = `
                            <a href="{{ url('/admin/users/`+data+`') }}" class="btn btn-sm btn-icon btn-info flex-end" data-bs-toggle="tooltip" aria-label="Detail" data-bs-original-title="Detail">
                        ...
                        var btn_edit = `
                            <a href="{{ url('/admin/users/`+data+`/edit') }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
