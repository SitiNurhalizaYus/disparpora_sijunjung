                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" id="form-data" name="form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="facilities" name="facilities" value=""
                                placeholder="Masukkan Fasilitas" required>
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-link">Fasilitas harus diisi dengan format yang benar.</p>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="operating_hours">Jam Operasional </label>
                            <input class="form-control" type="text" id="operating_hours" name="operating_hours" value=""
                                placeholder="Masukkan Jam Operasional" required>
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-link">Jam Operasional harus diisi dengan format yang benar.</p>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="ticket_price">Harga Tiket </label>
                            <input class="form-control" type="number" id="ticket_price" name="ticket_price" value=""
                                placeholder="Masukkan Harga Tiket" required>
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-link">Harga Tiket harus diisi dengan format yang benar.</p>
                        </div>
                        <div class="form-group">
                            ...
                            <br><label class="form-label" for="photo" style="font-size: 10pt">*Format JPG,JPEG, dan PNG</label>
