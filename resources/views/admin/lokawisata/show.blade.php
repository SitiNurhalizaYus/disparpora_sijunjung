    ...
    <div class="container-fluid content-inner mt-n5 py-0" style="margin-top: 100px !important;">
        <div class="card-header mb-2 px-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ url('/admin/lokawisatas/' . $slug . '/edit') }}" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil"></i> Edit
                    </a>
                    <button onclick="removeData({{ $slug }})" class="btn btn-danger btn-sm">
                            ...
                            <div class="col-md-12">
                                <div class="card mb-3" style="box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2);">
                                    ...
                                    <div class="card-body text-center">
                                        <img id="image" class="img-fluid rounded" alt="Lokawisata Image"
                                            style="max-width: 100%;">
                                    </div>
                                </div>
                                <div class="card mb-3" style="box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2);">
