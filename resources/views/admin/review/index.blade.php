        ...
        $('#datatable').DataTable( {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        var btn_detail = `
                            <a href="{{ url("/admin/review/`+data+`") }}" class="btn btn-sm btn-icon btn-info flex-end" data-bs-toggle="tooltip" aria-label="Detail" data-bs-original-title="Detail">
                        ...
                        success: function (result) {
                            if(result['success'] == true) {
                                Swal.fire({
                                    ...
                                    window.location.replace("{{ url('/admin/review') }}");
                                });
                            } else {
                                Swal.fire({
                                    icon: "error",
