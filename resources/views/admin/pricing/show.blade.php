            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div style="display: flex;">
                                <a href="{{ url("/admin/pricing/".$id."/edit") }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                    ...
                    <div class="card-body" id="detail-data-success" style="display: none;">
                        ...
                        <div class="mt-2">
                            <h6 class="mb-1">Description Short</h6>
                            <p id="description_short"></p>
                        </div>
                        <div class="mt-2">
                            <h6 class="mb-1">Description Long</h6>
