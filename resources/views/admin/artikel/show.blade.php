...
@section('content')
        ...
        <div class="card-header mb-2 px-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h3 class="card-title">
                        <!-- Tombol Back -->
                        <a href="{{ url('/admin/artikels/') }}" class="text-decoration-none text-dark">
                            ...
                            <div class="col-md-12">
                                <div class="card mb-3" style="box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2);">
                                    ...
                                    <div class="card-body text-center">
                                        <img id="image" class="img-fluid rounded" alt="Artikel Image"
                                            style="max-width: 100%;">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Request untuk mendapatkan data artikels
            $.ajax({
                url: '/api/content/{{ $id_content }}?type=artikel',
                type: "GET",
                dataType: "json",
                processData: false,
                success: function(result) {
                    ...
                    if (result['success']) {
                        ...
                        if (user_level_id == 3 && is_active == 1) {
                            ...
                            actionButtonsHtml += `
                                <a href="{{ url('/admin/artikels/' . $id_content . '/edit') }}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Request untuk menghapus data artikels
                    $.ajaxSetup({
                        headers: {
                            'Authorization': "Bearer {{ $session_token }}"
                        }
