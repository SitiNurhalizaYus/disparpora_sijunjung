...
@section('content')
        ...
        <div class="card-header mb-2 px-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h3 class="card-title">
                        <!-- Tombol Back -->
                        <a href="{{ url('/admin/artikel/') }}" class="text-decoration-none text-dark">
                ...
                <div>
                    <a href="{{ url('/admin/artikel/' . $id_content . '/edit') }}" class="btn btn-warning btn-sm">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Request untuk mendapatkan data artikel
            $.ajax({
        ...
        function removeData(id_content) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Request untuk menghapus data artikel
                    $.ajaxSetup({
                        headers: {
                            'Authorization': "Bearer {{ $session_token }}"
                        }
