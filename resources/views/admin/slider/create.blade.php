                    ...
                    <div class="card-body">
                        <form method="POST" class="needs-validation" id="form-data" name="form-data" novalidate>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="name">Nama Slider</label>
                                <input class="form-control" type="text" id="name" name="name" value=""
                                    placeholder="Masukkan Nama Slider" required pattern="[A-Za-z0-9\s]+$">
                                <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-name">Nama slider harus diisi dan tidak boleh ada simbol.</p>
                            </div>
                            <div class="form-group">
