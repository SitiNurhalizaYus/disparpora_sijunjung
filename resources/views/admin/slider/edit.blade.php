                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" id="form-data" name="form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-name">Nama hanya boleh berisi huruf, angka, dan spasi.</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="url" id="link" name="link" value="" placeholder="Masukkan Link" required>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-file">File yang diunggah harus berupa gambar (.jpg, .jpeg, .png).</p>
                        </div>
                        <div class="form-group">
