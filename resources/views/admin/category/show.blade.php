        ...
        <div class="card-header mb-3 px-3">
            <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="card-title">
                        <!-- Tombol Back -->
                        <a href="{{ url('/admin/projectcategory/') }}" style="text-decoration: none; color: inherit;">
                            ...
                            Portofolio/Kategori - Detail
                        </a>
                    </h3>
                </div>
                <div style="display: flex;">
                    <a href="{{ url('/admin/projectcategory/' . $id . '/edit') }}"
                    ...
                    &nbsp;
                    <button onclick="removeData({{ $id }})" class="btn btn-sm btn-icon btn-danger flex-end"
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body" id="detail-data-success" style="display: none;">
                        <div class="mt-2">
                            <h6 class="mb-1">Kategori Layanan</h6>
                            <p id="name"></p>
                        </div>
                        <div class="mt-2">
                            <hr style="height: 2px">
