                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" id="form-data" name="form-data" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" style="display: none; font-size: 0.75rem;" id="invalid-category">Kategori harus dipilih.</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description_short" name="description_short" rows="4"
                                placeholder="Masukkan Deskripsi Singkat" required>{{ old('description_short') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" id="content" name="content" style="display: none" required>{{ old('content') }}</textarea>
                            <textarea class="form-control" id="description_long" name="description_long" placeholder="Masukkan konten" required>{{ old('description_long') }}</textarea>
                        </div>
