            ...
            <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                    <div class="header-title">
                        <h2 class="card-title">Poster</h2>
                        <p>List data</p>
                    </div>
                </div>
                <div>
                    <a href="{{ url('/admin/posters/create') }}" class="btn btn-md 2 btn-primary">
                        ADD+
                    </a>
                </div>
            </div>
        ...
        $('#datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'description',
                    render: function(data, type, row, meta) {
                        return '<span style="white-space: normal;">' + data.substring(0, 100) +
                            '...</span>';
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        var btn_detail = `
                <a href="{{ url('/admin/posters/`+data+`') }}" class="btn btn-sm btn-icon btn-info flex-end" data-bs-toggle="tooltip" aria-label="Detail" data-bs-original-title="Detail">
                    <span class="btn-inner">
                        ...
                        var btn_edit = `
                <a href="{{ url('/admin/posters/`+data+`/edit') }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                    <span class="btn-inner">
                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
