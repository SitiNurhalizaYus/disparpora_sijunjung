    ...
    <div class="container-fluid position-relative p-0">
        ...
        <script>
            $(document).ready(function() {
                ...
                // Fungsi untuk memuat konten berita dengan AJAX
                    ...
                    <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <a class="text-uppercase" href="{{ url('/berita') }}/${content.slug}">Baca Selengkapnya <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>`;
                                });
                ...
                // Memuat data berita pertama kali
