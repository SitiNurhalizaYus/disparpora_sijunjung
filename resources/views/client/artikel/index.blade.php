    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-3 bg-light">
            <div class="text-star px-5">
                ...
                <span class="text-green">artikel</span>
            </div>
        </div>
                                    ...
                                    <div class="blog-item bg-light rounded overflow-hidden">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <a class="text-uppercase"
                                                href="{{ url('/content/' . $konten['id_content'] . '?type=artikel') }}">Read
                        ...
                        <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                @foreach ($categories as $category)
                                    <a href="{{ url('/artikel?category_id=' . $category['id_category']) }}"
                        ...
                        <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            @foreach ($recentPosts as $post)
                                <div class="d-flex rounded overflow-hidden mb-3">
                                    ...
                                    <a href="{{ url('/artikel/' . $post['id_content']) }}"
