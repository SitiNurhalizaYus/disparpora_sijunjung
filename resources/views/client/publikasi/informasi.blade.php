    ...
    <div class="container-fluid position-relative p-0">
            ...
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <div class="logo-text">
                        ...
                        <p>
                            Publikasi adalah konten terbaru dari DISPARPORA, termasuk informasi, produk hukum, laporan, dan dokumen penting lainnya, diperbarui secara berkala untuk memastikan transparansi dan akses publik.</p>
        ...
        <div class="container-fluid bg-primary py-3 bg-light">
            <div class="text-star px-5">
                ...
                <a href="{{url('publikasi/' . $konten['slug'])}}" class="text-green">{{ $konten['judul']}}</a>
            </div>
        </div>
