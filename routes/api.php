...
Route::apiResource('virtual_tour', App\Http\Controllers\Api\VirtualTourController::class); 
...
Route::post('message/{id}/send-confirmation', [App\Http\Controllers\Api\MessageController::class, 'sendConfirmationEmail']);
